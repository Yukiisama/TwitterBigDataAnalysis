...
public class HBaseTopKTripleHashtag extends SparkToDatabase {
    ...
    private static HBaseTopKTripleHashtag __instance__;

    public HBaseTopKTripleHashtag() {
        super(tableName, familyName, new String[]{"hashtag1", "hashtag2", "hashtag3", "count"});
    }
    public HBaseTopKTripleHashtag(String tablename) {
        super(tablename, familyName, new String[]{"hashtag1", "hashtag2", "hashtag3", "count"});
    }

    public static HBaseTopKTripleHashtag INSTANCE(String tableName) {
        if (__instance__ == null) {
            __instance__ = new HBaseTopKTripleHashtag(tableName);
        }
    ...
    public void writeTable(Tuple2<Tuple3<String,String,String>, Integer> data) {
